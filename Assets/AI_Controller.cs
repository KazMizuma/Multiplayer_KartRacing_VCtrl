...
public class AI_Controller : MonoBehaviour
{
    ...
    public bool crssTrfcTurnLeft = false; // 7/07 Trfc Ctrl
    ...
    void Update()
    {
        ...
        else //***TRAFFIC CONTROL ELSE IF{} TEST CODES BEGIN (CONTINUE ALL THE WAY TO THE END OF THE PAGE) 5/01/22***
        {
            ...
            else // if not at the initial starting point
            {
                ...
                //else if (raycasting.downRayText == "Lights") // 7/21 Trfc Ctrl TEST
                //{
                //    accelTrfc = 0.225f;
                //    brakeTrfc = 0.025f;
                //}
            ...
            if (distanceToTargetTrfc < 3) // increase the value if gameObject circles around the waypoint.
            {
                ...
                IEnumerator Wait(int way) // 6/22 Trfc Ctrl Test Codes
                {
                    ...
                    switch (way) // 6/24 Trfc Ctrl Test Codes
                    {
                        ...
                        case (18): // Lights, 7/18 Trfc Ctrl TEST
                            // Right Turn
                            if (rightTurn == true) // and the light is red
                            {
                                ...
                                {
                                    if (wayPointsTrfc.waypoints[46].GetComponent<RaycastingLights2>().nameIs == wayPointsTrfc.waypoints[46].name)
                                    {
                                        wayPointsTrfc.waypoints[way].gameObject.GetComponent<BoxCollider>().isTrigger = true;
                                        rightTurn = false;
                                        timeStampTrafficLight.at18Direction = "";
                        ...
                        case (36): // Lights, 7/18 Trfc Ctrl TEST
                            // Right Turn
                            if (rightTurn == true) // and the light is red
                            {
                                ...
                                {
                                    if (wayPointsTrfc.waypoints[18].GetComponent<RaycastingLights4>().nameIs == wayPointsTrfc.waypoints[18].name)
                                    {
                                        wayPointsTrfc.waypoints[way].gameObject.GetComponent<BoxCollider>().isTrigger = true;
                                        rightTurn = false;
                                        timeStampTrafficLight.at36Direction = "";
                        ...
                        case (46): // Lights, 7/18 Trfc Ctrl TEST
                            // Right Turn
                            if (rightTurn == true) // and the light is red
                            {
                                ...
                                {
                                    if (wayPointsTrfc.waypoints[6].GetComponent<RaycastingLights3>().nameIs == wayPointsTrfc.waypoints[6].name)
                                    {
                                        wayPointsTrfc.waypoints[way].gameObject.GetComponent<BoxCollider>().isTrigger = true;
                                        rightTurn = false;
                                        timeStampTrafficLight.at46Direction = "";
                ...
                //if (currentPointTrfc == 7 && raycasting.atThresholdTrfc == true) // At Cube (6), No Lights, Box Collider & Is Trigger MUST BE CHECKED!
                //{
                ...
                if (currentPointTrfc == 7 && raycasting.atThresholdTrfc == true) // At Cube (6), Lights, 7/17 Trfc Ctrl TEST
                {
                    timeStampTrafficLight.timeAt6 = Time.time; 
                    //Debug.Log(this.gameObject.name + "'s Time at Cube (" + (currentPointTrfc - 1) + ") is " + Time.time);
                ...
                if (currentPointTrfc == 19 && raycasting.atThresholdTrfc == true) // At Cube (18), Lights, 7/18 Trfc Ctrl TEST
                {
                    timeStampTrafficLight.timeAt18 = Time.time;
                    //Debug.Log(this.gameObject.name + "'s Time at Cube (" + (currentPointTrfc - 1) + ") is " + Time.time);
                ...
                if (current == 18 && currentPointTrfc == 87 && raycasting.atThresholdTrfc == true) // at Cube (86), 7/22 Trfc Ctrl Test Codes
                {
                    currentPointTrfc = 23;
                    raycasting.atThresholdTrfc = false;
                }
                ...
                if (currentPointTrfc == 47 && raycasting.atThresholdTrfc == true) // At Cube (46), Lights, 7/18 Trfc Ctrl TEST
                {
                    timeStampTrafficLight.timeAt46 = Time.time;
                    //Debug.Log(this.gameObject.name + "'s Time at Cube (" + (currentPointTrfc - 1) + ") is " + Time.time);
                ...
                if (current == 46 && currentPointTrfc == 87 && raycasting.atThresholdTrfc == true) // at Cube (86), 7/22 Trfc Ctrl Test Codes
                {
                    currentPointTrfc = 22;
                    raycasting.atThresholdTrfc = false;
                }
                ...
                if (currentPointTrfc == 37 && raycasting.atThresholdTrfc == true) // At Cube (36), Lights, 7/18 Trfc Ctrl TEST
                {
                    timeStampTrafficLight.timeAt36 = Time.time;
                    //Debug.Log(this.gameObject.name + "'s Time at Cube (" + (currentPointTrfc - 1) + ") is " + Time.time);
